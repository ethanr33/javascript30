...
console.log(inventors.filter(person => Math.floor(person.year / 100) == 15));

// Array.prototype.map()
// 2. Give us an array of the inventors' first and last names

console.log('All inventors\' first and last names');
inventors.map(person => console.log(`${person.first} ${person.last}`));
...
console.log(inventors.reduce((total, person) => (person.passed - person.year) + total, 0));
